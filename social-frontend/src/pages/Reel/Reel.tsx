...
export default function Reel() {
  ...
  if (!active) {
    return <div className="ig-reels"><div className="ig-reels__stage"><div className="ig-reels__empty">Chưa có reel nào.</div></div></div>;
  }
  ...
  return (
    <div className="ig-reels">
      <div className={`ig-reels__stage ${commentsOpen ? "is-comments-open" : ""}`}>
                ...
                <div className="ig-reels__slide" key={r.id}>
                  ...
                  <div className="ig-reels__overlay">
                    <div className="ig-reels__userRow">
                      <img className="ig-reels__avatar" src={getAvatarUrl({ username: r.username, avatarUrl: r.avatarUrl })} alt={r.username} />
        ...
        <ReelComments
          isOpen={commentsOpen}
          postId={active.postId || active.id}
